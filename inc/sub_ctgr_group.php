		...
		<div class="full_box">
			...
			<ul class="depth1 n6">
				...
				<li>
					...
					<ul class="depth2">
						<?php
						$prd_arr = get_category_product("02_te",$v['cid']);
						foreach($prd_arr as $key3 => $v3) {
						?>
						<li><a class="<?php echo ($_GET['pid'] == $v3['pid'])?"on":"" ?>" href="prod1_detail.php?cid=<?php echo $v['cid']; ?>&pid=<?php echo $v3['pid']; ?>"><?php echo $v3['product_name']; ?></a></li>
						<?php
						}
						?>
