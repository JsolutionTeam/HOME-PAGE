	<div id="header">
		<div class="inner">
			...
			<div class="gnb_wrap">
				...
				<ul class="gnb">
					<li class="gnb-1dep">
						<h3><a href="../about.php" class="on">회사소개</a></h3>
						<ul class="gnb-2dep">
					...
					<li class="gnb-1dep">
						<h3><a href="../prod1_list.php">통신상품</a></h3>
						<ul class="gnb-2dep">
					...
					<li class="gnb-1dep">
						<h3><a href="../prod2_category.php">전자제품</a></h3>
						<ul class="gnb-2dep">
					...
					<li class="gnb-1dep">
						<h3><a href="../prod3_category.php">ICT 및 솔루션</a></h3>
					</li>
					<li class="gnb-1dep">
						<h3><a href="../consulting.php">맞춤 컨설팅</a></h3>
					</li>
					<li class="gnb-1dep"><h3><a class="link" href="">임직원몰</a></h3></li>
					<li class="gnb-1dep">
						<h3><a href="../notice.php">고객지원</a></h3>
						<ul class="gnb-2dep">
							<li><a href="../notice.php">공지사항</a></li>
							<li><a href="../customer.php">자주하는 질문</a></li>
						</ul>
					</li>
				</ul>
				<script>
